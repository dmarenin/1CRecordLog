...
class ExternalRecordLog_Handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        post_data_txt = self.rfile.read(content_length)
        post_data_txt = post_data_txt.decode('utf-8-sig')

        post_data = json.loads(post_data_txt)
        
        res = self.callback(path, post_data, self)
